...
// ClearPolicies resets all communication blocks to be unblocked
func (tp *NetworkPolicy) ClearPolicies() {
	for commStr := range tp.rpcPolicy {
		tp.rpcPolicy[commStr] = true
	}
}
